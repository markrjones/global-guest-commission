<?php
error_log("In the plugin's content-booking template");
if (isset($data)) :
...
<?php
	...
	?>
				...
				if ($data->price) : 
                    ...
                    // MRJ
                    // This is where prices of bookings are shown on Owner dashboard. They include commission so we deduct it
                    ...
                    $data->price = $data->price / (1 + $guest_commission_rate / 100);
